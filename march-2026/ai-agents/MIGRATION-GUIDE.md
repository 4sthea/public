# AI Ecosystem v3 Migration Guide — Research-Driven Restructuring
...
AI Ecosystem v3 applies three research findings to radically simplify the governance ecosystem:
...
| `governance.instructions.md`      | what-belongs-where + AI Ecosystem-system-context + artifact ownership | Consolidated AI Ecosystem rules: agent roster, artifact ownership table, placement decision tree, dependency read contract, change propagation        |
...
| Prompt                                   | Why                                                                                                                    |
| ---------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| `create-agent.prompt.md`                 | Meta-governance — AI Ecosystem governing itself. Rarely used. The governance instruction provides equivalent guidance. |
...
| File                         | Why                                                                                        |
| ---------------------------- | ------------------------------------------------------------------------------------------ |
| `artifact-lint.procedure.md` | Companion to deleted lint infrastructure. Meta-governance for auditing AI Ecosystem files. |
...
| File                       | Why                                                         |
| -------------------------- | ----------------------------------------------------------- |
| `agent.template.md`        | AI Ecosystem scaffold for creating agents. Meta-governance. |
| `instructions.template.md` | AI Ecosystem scaffold. Meta-governance.                     |
| `prompt.template.md`       | AI Ecosystem scaffold. Meta-governance.                     |
| `procedure.template.md`    | AI Ecosystem scaffold. Meta-governance.                     |
...
| `AI Ecosystem-system-context.md` | 300-line AI Ecosystem explainer. Valuable for onboarding but loaded into context every time. Key rules migrated to `governance.instructions.md`. | Move to `docs/architecture/` for reference. Delete from `.github/context/`. |
...
These are meta-checklists for creating AI Ecosystem files. The deleted create-\* prompts contained equivalent guidance. The governance instruction now covers placement rules.
...
- `AI Ecosystem-prompt-training.md` → `docs/training/`
...
14. Delete 3 context files: `context-pointers`, move `AI Ecosystem-system-context` and `what-belongs-where` to `docs/`
15. Delete standalone checklists and empty directories

### Phase 5: Update references

16. Update `AI Ecosystem-system-context.md` (now in docs/) agent roster table
